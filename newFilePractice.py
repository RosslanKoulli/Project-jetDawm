...
app = Ursina()
Sky()
player = FirstPersonController(y = 6, origin_y =-.5)
...
wall_3 = duplicate(wall_2,z =10)
wall_4 = Entity(model = "cube", collider = "box", position = (-15,0,10), scale= (1,5,10), rotation = (0,0,0), texture = "brick", texture_scale = (5,5), color = color.rgb(255,128,0))
